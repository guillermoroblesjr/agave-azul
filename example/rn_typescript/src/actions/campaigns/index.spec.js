...
import campaigns from '~/src/actions/campaigns'
// import campaignsThunk from '~/src/actions/campaigns'
...
describe(`(Action Creators)`, () => {
  describe(`campaigns`, () => {
    ...
    it(`Should be exported as a function.`, () => {
      expect(campaigns).to.be.a('function')
    })
  ...
  //   })
  //
  //   it(`Should dispatch campaignsThunk()`, () => {
  //     const action = campaignsThunk()
